...
public class Symbol
{
	...
	@SafeVarargs
	public Symbol(Privilege requiredPrivileges, Signature signature, ResolutionPhase<T>... phases)
	{
	...
	public Symbol<T> getClosestSymbol(Privilege providedPrivileges, Signature signature)
	{
		...
		{
			for (Symbol<T> symbol : phase.getSymbols(providedPrivileges, signature))
			{
	...
	public ResolutionPhase<T>[] getResolutionPhases(@SuppressWarnings("unchecked") T... phaseTypes)
	{
